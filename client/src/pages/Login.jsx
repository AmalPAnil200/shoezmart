...
const Login = () => {
  ...
  // 3. Extract the message from ProtectedRoute state
  ...
  const handleLogin = async (e) => {
    ...
    try {
      ...
      if (res.data.user.role === "admin") {
        ...
        // OPTIONAL: If they were redirected here, send them back to where they wanted to go
    ...
    <div className="min-h-screen flex">
      ...
      <div className="w-full lg:w-1/2 bg-stone-50 flex items-center justify-center p-8 relative">
        ...
        <div className="w-full max-w-sm">
          {/* 4. FLASH MESSAGE UI */}
          {flashMessage && (
            <div className="mb-6 p-4 bg-pink-50 border-l-2 border-pink-500 flex items-center justify-between animate-in fade-in slide-in-from-top-4 duration-500">
              <p className="text-[10px] uppercase tracking-[0.2em] text-pink-700 font-bold">
                {flashMessage}
              </p>
              <button
                onClick={() =>
          ...
          <div className="mb-10">
            <h2 className="text-4xl font-light text-zinc-900 leading-snug">
              Welcome{" "}
              <span className="text-pink-500 font-semibold italic">back</span>
            </h2>
          ...
          <form onSubmit={handleLogin} className="space-y-7">
            ...
            <button
              type="submit"
              disabled={loading}
              className="w-full mt-2 py-4 bg-zinc-900 hover:bg-pink-500 text-white text-xs tracking-widest uppercase transition-colors duration-300 disabled:opacity-50 disabled:cursor-not-allowed shadow-xl shadow-zinc-200 hover:shadow-pink-100"
            >
          ...
          <div className="flex justify-between text-xs text-zinc-400 tracking-wide">
            <a
              ...
              size="text-pink-500 hover:underline underline-offset-4"
            >
              Forgot password?
            </a>
            <a
